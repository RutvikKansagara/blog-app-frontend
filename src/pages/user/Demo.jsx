    ...
    return (
        <>
            <div className='grid justify-items-center w-full m-10 mt-48'>
                <form onSubmit={submit} className='shadow-lg px-10 min-w-[10rem] rounded-md py-7 bg-white'>
                    ...
                    <p>
                        ...
                        <span className='text-blue-700 tracking-wide font-semibold'>
                            <NavLink to="/auth/register" className="hover:border-b-2 border-blue-600">
                                Register
                            </NavLink>
                        </span>
                    </p>
                    <button type="submit" className='bg-blue-600 hover:bg-blue-700 text-white px-5 py-1.5 rounded-md cursor-pointer mt-4'>Login</button>
                </form>
            </div>
        </>
    )
